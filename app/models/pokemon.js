...
var PokemonModel = DS.Model.extend({
  name: DS.attr('string'),
...
PokemonModel.reopenClass({
  FIXTURES: [{
    ...
    "baseHP": 50,
    "baseSpeed": 91,
    "types": ["electric", "ghost", "electric", "ice", "electric", "fire", "electric", "grass", "electric", "flying", "electric", "water"]
  }, {
    "id": 480,
    "name": "Uxie",
    "catchRate": 3,
    ...
    "baseHP": 100,
    "baseSpeed": 90,
    "types": ["normal", "psychic", "normal", "fighting"]
  }, {
    "id": 649,
    "name": "Genesect",
    "catchRate": 3,
